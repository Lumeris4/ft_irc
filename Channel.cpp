...
/*   Updated: 2025/09/16 08:16:23 by lelanglo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Channel::Channel(std::string name, std::string creator): _name(name), _limit(MAX_CLIENT), _access(false), _access_topic(true), _members(1)
{
	this->_password = "";
